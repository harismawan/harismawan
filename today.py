...
def recursive_loc(owner, repo_name, data, cache_comment, addition_total=0, deletion_total=0, my_commits=0, cursor=None):
    ...
    for attempt in range(5): # GitHub answers expensive history pages with a 502; back off and retry before giving up
...
if __name__ == '__main__':
    """
    Achmad Fauzi Harismawan (harismawan)
    Card format and stat-collection logic adapted from Andrew Grant (Andrew6rant), 2022-2025
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1994, 4, 8))
